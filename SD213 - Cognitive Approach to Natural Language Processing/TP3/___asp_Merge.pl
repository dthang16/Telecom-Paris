...
rescue0(vp, AS1, AS2) :-		% rescue0 by repetition
	repeat(AS1, AS2).			% repeat only actions
	% rescue0(vp, AS3, AS2).		% looping on rescuing vp
/*
...
slice(AS, AS1) :-
	fail,	% suppress this line to enable slicing
